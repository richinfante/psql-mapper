 ...
 */
module.exports.mapSingle = function mapSingle (query, map, Constructor) {
 ...
 * @returns {function(Object, function(Error, Object))}
 */
module.exports.mapSingleStrict = function mapSingleStrict (query, map, Constructor) {
  // Ensure queries are prepared
  if (typeof query === 'string') {
    query = prepare(query)
  }
 ...
 */
module.exports.mapMultiple = function mapMultiple (query, map, Constructor) {
  // Ensure queries are prepared
  if (typeof query === 'string') {
    query = prepare(query)
  }
